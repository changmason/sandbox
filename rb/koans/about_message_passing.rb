...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    assert_equal true, mc.__send__(:caught?) ## NOTICE: this is really important, because sometimes we may have #send clash with existing send method
  ...
  def test_catching_messages_makes_respond_to_lie
    ...
    assert_equal false, catcher.respond_to?(:any_method) ## NOTICE, this is fucking important, what I capture by method_missing are not real methods exist, it is just that ruby know how to react your call
