...
class AboutScope < EdgeCase::Koan
  ...
  def test_nested_string_is_not_the_same_as_the_system_string ## NOTICE this
  ...
  def test_you_can_get_a_list_of_constants_for_any_class_or_module
    assert_equal ["Dog"], Jims.constants if RUBY_VERSION.match(/1.8/)
    assert_equal [:"Dog"], Jims.constants if RUBY_VERSION.match(/1.9/)
