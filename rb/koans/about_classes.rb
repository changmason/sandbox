...
class AboutClasses < EdgeCase::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    ...
    fido.set_name("Fido")
    assert_equal ["@name"], fido.instance_variables if RUBY_VERSION.match(/1.8/)
    assert_equal [:"@name"], fido.instance_variables if RUBY_VERSION.match(/1.9/)
  end
  ...
  def test_all_objects_support_to_s_and_inspect
    ...
    assert_equal "123", array.to_s if RUBY_VERSION.match(/1.8/)
    assert_equal "[1, 2, 3]", array.to_s if RUBY_VERSION.match(/1.9/)
